...
- Production v7 verification confirmed that `https://deltawatch-jayyutyh.manus.space/api/spatial/metadata` returns `maubin-flood-event-hgb-v7` and that the public dashboard displays **HGB v7 · 2018 holdout**, **15.7% precision**, **23.5% recall**, and the expanded experimental limitation.
