...
/**
 * Returns a persistent, non-identifying contributor record for this browser.
 * Only a random opaque cookie is held client-side; the database receives a hash-derived identifier.
 */
