...
type NationalEvidenceReadiness = { region_count?: number; regions?: Array<{ admin1_pcode: string; admin1_name: string; evidence_readiness: string }>; static_context?: { status?: string; interpretation?: string }; upstream_flow_readiness?: { status?: string; regions_with_source_snapshot?: number; model_feature_authorized?: boolean; reason?: string }; prospective_validation_readiness?: { status?: string; model_evaluation_authorized?: boolean; reason?: string }; candidate_gate?: { status?: string; model_status?: string; reason?: string }; interpretation?: string; limits?: string[] };
